...
#ifndef JOINTSTRUCT_MODEL_H
#define JOINTSTRUCT_MODEL_H

/**
 * @file jointStructModel.h
 * @brief Contains the definition of class jointStructModel
 * @author Brian Tietz
 * $Id$
 */
...
/**
 * The jointStructModel implements a tensegrity with rigid
 * tetrahedrons and six strings between segments, also known as
 * Tetraspine. 
 */
class jointStructModel: public tgSubject<jointStructModel>, public tgModel
{
public: 
