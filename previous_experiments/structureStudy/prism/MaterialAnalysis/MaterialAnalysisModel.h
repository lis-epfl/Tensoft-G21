...
#ifndef MATERIALANALYSIS_MODEL_H
#define MATERIALANALYSIS_MODEL_H

/**
 * @file MaterialAnalysisModel.h
 * @brief Contains the definition of class MaterialAnalysisModel
 * @author Brian Tietz
 * $Id$
 */
...
/**
 * The MaterialAnalysisModel implements a tensegrity with rigid
 * tetrahedrons and six strings between segments, also known as
 * Tetraspine. 
 */
class MaterialAnalysisModel: public tgSubject<MaterialAnalysisModel>, public tgModel
{
public: 
